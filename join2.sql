...
select stu.student_id,stu.student_name,en.enrollment_id,course_name from students as stu
...
select char_length(st.student_name),count(en.enrollment_id) from students as st
join enrollments as en
on st.student_id = en.student_id
